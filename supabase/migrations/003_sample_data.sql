...
-- All IDs use valid hex characters only (0-9, a-f)
-- ============================================================
...
INSERT INTO goals (id, employee_id, title, description, category, start_date, due_date, progress, status) VALUES
  ...
  ('d3000001-0000-4000-8000-000000000002', 'e2000001-0000-4000-8000-000000000003', 'Close 5 enterprise deals', 'Target: Close 5 deals worth ₹50L+ each this quarter', 'performance', '2026-04-01', '2026-06-30', 40, 'in_progress'),
